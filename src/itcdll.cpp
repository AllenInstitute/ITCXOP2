...
#define DEBUGPRINT_SIZEOF(A)                                                   \
  fmt::format_to(xd.buf, FMT_STRING("sizeof(" #A ")={}\r"), sizeof(A));
...
public:
  XOPNoticeOnDestruct()
  {
    ...
    {
      fmt::format_to(buf, FMT_STRING("(main thread)\r"));
    }
    else
    {
      fmt::format_to(buf, FMT_STRING("(thread {})\r"), GetCurrentThreadId());
    }
  }
              ...
              const std::vector<ITCChannelInfo> &chanInfo)
{
  ...
  {
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ModeNumberOfPoints={}\r"),
                   i, chanInfo[i].ModeNumberOfPoints);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ChannelType={}\r"), i,
                   chanInfo[i].ChannelType);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ChannelNumber={}\r"), i,
                   chanInfo[i].ChannelNumber);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ChannelMode={}\r"), i,
                   chanInfo[i].ChannelMode);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ErrorMode={}\r"), i,
                   chanInfo[i].ErrorMode);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ErrorState={}\r"), i,
                   chanInfo[i].ErrorState);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].FIFOPointer={:#x}\r"), i,
                   (UINT_PTR) chanInfo[i].FIFOPointer);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].FIFONumberOfPoints={}\r"),
                   i, chanInfo[i].FIFONumberOfPoints);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ModeOfOperation={}\r"), i,
                   chanInfo[i].ModeOfOperation);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].SizeOfModeParameters={}\r"),
                   i, chanInfo[i].SizeOfModeParameters);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ModeParameters={:#x}\r"), i,
                   (UINT_PTR) chanInfo[i].ModeParameters);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].SamplingIntervalFlag={}\r"),
                   i, chanInfo[i].SamplingIntervalFlag);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].SamplingRate={}\r"), i,
                   chanInfo[i].SamplingRate);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].StartOffset={}\r"), i,
                   chanInfo[i].StartOffset);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].Gain={}\r"), i,
                   chanInfo[i].Gain);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].Offset={}\r"), i,
                   chanInfo[i].Offset);
    fmt::format_to(xd.buf, FMT_STRING("ChanInfo[{}].ExternalDecimation={}\r"),
                   i, chanInfo[i].ExternalDecimation);
    fmt::format_to(xd.buf,
              ...
              const std::vector<ITCChannelDataEx> &chanDataEx)
{
  ...
  {
    fmt::format_to(xd.buf, FMT_STRING("chanDataEx[{}].ChannelType={}\r"), i,
                   chanDataEx[i].ChannelType);
    fmt::format_to(xd.buf, FMT_STRING("chanDataEx[{}].Command={}\r"), i,
                   chanDataEx[i].Command);
    fmt::format_to(xd.buf, FMT_STRING("chanDataEx[{}].ChannelNumber={}\r"), i,
                   chanDataEx[i].ChannelNumber);
    fmt::format_to(xd.buf, FMT_STRING("chanDataEx[{}].Status={}\r"), i,
                   chanDataEx[i].Status);
    fmt::format_to(xd.buf, FMT_STRING("chanDataEx[{}].Value={}\r"), i,
                   chanDataEx[i].Value);
    fmt::format_to(xd.buf, FMT_STRING("chanDataEx[{}].DataPointer={:#x}\r"), i,
...
void DebugOut(const std::string &caller, const ITCPublicConfig &config)
{
  ...
  fmt::format_to(xd.buf, FMT_STRING("config.DigitalInputModed=[{}]\r"),
                 config.DigitalInputMode);
  fmt::format_to(xd.buf, FMT_STRING("config.ExternalTriggerModed=[{}]\r"),
                 config.ExternalTriggerMode);
  fmt::format_to(xd.buf, FMT_STRING("config.ExternalTriggerd=[{}]\r"),
                 config.ExternalTrigger);
  fmt::format_to(xd.buf, FMT_STRING("config.EnableExternalClockd=[{}]\r"),
                 config.EnableExternalClock);
  fmt::format_to(xd.buf, FMT_STRING("config.DACShiftValued=[{}]\r"),
                 config.DACShiftValue);
  fmt::format_to(xd.buf, FMT_STRING("config.InputRanged=[{}]\r"),
                 config.InputRange);
  fmt::format_to(xd.buf, FMT_STRING("config.TriggerOutPositiond=[{}]\r"),
                 config.TriggerOutPosition);
  fmt::format_to(xd.buf, FMT_STRING("config.OutputEnabled=[{}]\r"),
                 config.OutputEnable);
  fmt::format_to(xd.buf, FMT_STRING("config.SequenceLengthd=[{}]\r"),
                 config.SequenceLength);
  fmt::format_to(xd.buf, FMT_STRING("config.Sequenced=[{}]\r"),
                 (UINT_PTR) config.Sequence);
  fmt::format_to(xd.buf, FMT_STRING("config.SequenceLengthInd=[{}]\r"),
                 config.SequenceLengthIn);
  fmt::format_to(xd.buf, FMT_STRING("config.SequenceInd=[{}]\r"),
                 (UINT_PTR) config.SequenceIn);
  fmt::format_to(xd.buf, FMT_STRING("config.ResetFIFOFlagd=[{}]\r"),
                 config.ResetFIFOFlag);
  fmt::format_to(xd.buf, FMT_STRING("config.ControlLightd=[{}]\r"),
                 config.ControlLight);
  fmt::format_to(xd.buf, FMT_STRING("config.SamplingIntervald=[{}]\r"),
...
void DebugOut(const std::string &caller, const GlobalDeviceInfo &deviceInfo)
{
  ...
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.DeviceType=[{}]\r"),
                 deviceInfo.DeviceType);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.DeviceNumber=[{}]\r"),
                 deviceInfo.DeviceNumber);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.PrimaryFIFOSize=[{}]\r"),
                 deviceInfo.PrimaryFIFOSize);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.SecondaryFIFOSize=[{}]\r"),
                 deviceInfo.SecondaryFIFOSize);

  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.LoadedFunction=[{}]\r"),
                 deviceInfo.LoadedFunction);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.SoftKey=[{}]\r"),
                 deviceInfo.SoftKey);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.Mode=[{}]\r"), deviceInfo.Mode);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.MasterSerialNumber=[{}]\r"),
                 deviceInfo.MasterSerialNumber);

  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.SecondarySerialNumber=[{}]\r"),
                 deviceInfo.SecondarySerialNumber);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.HostSerialNumber=[{}]\r"),
                 deviceInfo.HostSerialNumber);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.NumberOfDACs=[{}]\r"),
                 deviceInfo.NumberOfDACs);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.NumberOfADCs=[{}]\r"),
                 deviceInfo.NumberOfADCs);

  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.NumberOfDOs=[{}]\r"),
                 deviceInfo.NumberOfDOs);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.NumberOfDIs=[{}]\r"),
                 deviceInfo.NumberOfDIs);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.NumberOfAUXOs=[{}]\r"),
                 deviceInfo.NumberOfAUXOs);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.NumberOfAUXIs=[{}]\r"),
                 deviceInfo.NumberOfAUXIs);

  fmt::format_to(xd.buf,
                 FMT_STRING("deviceInfo.MinimumSamplingInterval=[{}]\r"),
                 deviceInfo.MinimumSamplingInterval);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.MinimumSamplingStep=[{}]\r"),
                 deviceInfo.MinimumSamplingStep);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.FirmwareVersion0=[{}]\r"),
                 deviceInfo.FirmwareVersion0);
  fmt::format_to(xd.buf, FMT_STRING("deviceInfo.Reserved1=[{}]\r"),
...
void DebugOut(const std::string &caller, const ITCStatus &status)
{
  ...
  fmt::format_to(xd.buf, FMT_STRING("status.CommandStatus=[{}]\r"),
                 status.CommandStatus);
  fmt::format_to(xd.buf, FMT_STRING("status.RunningMode=[{}]\r"),
                 status.RunningMode);
  fmt::format_to(xd.buf, FMT_STRING("status.Overflow=[{}]\r"), status.Overflow);
  fmt::format_to(xd.buf, FMT_STRING("status.Clipping=[{}]\r"), status.Clipping);
  fmt::format_to(xd.buf, FMT_STRING("status.State=[{}]\r"), status.State);
  fmt::format_to(xd.buf, FMT_STRING("status.Reserved0=[{}]\r"),
                 status.Reserved0);
  fmt::format_to(xd.buf, FMT_STRING("status.Reserved1=[{}]\r"),
                 status.Reserved1);
  fmt::format_to(xd.buf, FMT_STRING("status.Reserved2=[{}]\r"),
                 status.Reserved2);
  fmt::format_to(xd.buf, FMT_STRING("status.TotalSeconds=[{}]\r"),
                 status.TotalSeconds);
  fmt::format_to(xd.buf, FMT_STRING("status.RunSeconds=[{}]\r"),
                 status.RunSeconds);
}
...
void DebugOut(const std::string &caller, const ITCGlobalConfig &config)
{
  ...
  fmt::format_to(xd.buf, FMT_STRING("config.SoftwareFIFOSize=[{}]\r"),
                 config.SoftwareFIFOSize);
  fmt::format_to(xd.buf, FMT_STRING("config.HardwareFIFOSize_A=[{}]\r"),
                 config.HardwareFIFOSize_A);
  fmt::format_to(xd.buf, FMT_STRING("config.HardwareFIFOSize_B=[{}]\r"),
                 config.HardwareFIFOSize_B);
  fmt::format_to(xd.buf, FMT_STRING("config.TransferSizeLimitation=[{}]\r"),
                 config.TransferSizeLimitation);
  fmt::format_to(xd.buf, FMT_STRING("config.Reserved0=[{}]\r"),
                 config.Reserved0);
  fmt::format_to(xd.buf, FMT_STRING("config.Reserved1=[{}]\r"),
                 config.Reserved1);
  fmt::format_to(xd.buf, FMT_STRING("config.Reserved2=[{}]\r"),
                 config.Reserved2);
  fmt::format_to(xd.buf, FMT_STRING("config.Reserved3=[{}]\r"),
                 config.Reserved3);
}
...
void DebugOut(const std::string &caller, const ITCStartInfo &config)
{
  ...
  fmt::format_to(xd.buf, FMT_STRING("config.ExternalTrigger=[{}]\r"),
                 config.ExternalTrigger);
  fmt::format_to(xd.buf, FMT_STRING("config.OutputEnable=[{}]\r"),
                 config.OutputEnable);
  fmt::format_to(xd.buf, FMT_STRING("config.StopOnOverflow=[{}]\r"),
                 config.StopOnOverflow);
  fmt::format_to(xd.buf, FMT_STRING("config.StopOnUnderrun=[{}]\r"),
                 config.StopOnUnderrun);
  fmt::format_to(xd.buf, FMT_STRING("config.RunningOption=[{}]\r"),
                 config.RunningOption);
  fmt::format_to(xd.buf, FMT_STRING("config.ResetFIFOs=[{}]\r"),
                 config.ResetFIFOs);
  fmt::format_to(xd.buf, FMT_STRING("config.NumberOf640usToRun=[{}]\r"),
                 config.NumberOf640usToRun);
  fmt::format_to(xd.buf, FMT_STRING("config.Reserved3=[{}]\r"),
                 config.Reserved3);
  fmt::format_to(xd.buf, FMT_STRING("config.StartTime=[{}]\r"),
                 config.StartTime);
  fmt::format_to(xd.buf, FMT_STRING("config.StopTime=[{}]\r"), config.StopTime);
}
